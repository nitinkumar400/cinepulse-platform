...
const DEFAULTS = {
  ...
  CORS_ORIGINS: '',
  JWT_EXPIRES_IN: runtime === 'production' ? '15m' : '30d',
  ADMIN_USERNAME: runtime === 'production' ? '' : 'admin',
  ADMIN_EMAIL: runtime === 'production' ? '' : 'admin@cinestream.local',
  ADMIN_PASSWORD: runtime === 'production' ? '' : 'Admin@12345',
